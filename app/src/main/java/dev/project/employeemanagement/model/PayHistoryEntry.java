...
public class PayHistoryEntry {
    ...
    public PayHistoryEntry(int empid, String name, String ssn, String jobTitle, String division,
                           String payDate, double earnings, double fedTax, double fedMed,
                           double fedSs, double stateTax, double retire401k, double healthCare) {
        this.empid = empid;
        this.name = name;
        this.ssn = ssn;
